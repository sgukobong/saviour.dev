...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="min-h-screen flex items-end justify-start relative overflow-hidden bg-white px-6 md:px-113 pb-113 md:pb-144">
        ...
        >
          ...
          <div className="flex flex-wrap gap-14 mb-22">
            <button className="btn-ghost text-caption uppercase tracking-[0.2em] hover:text-future-blue transition-colors">SaaS Development</button>
            <button className="btn-ghost text-caption uppercase tracking-[0.2em] hover:text-future-blue transition-colors">AI Automation</button>
            <button className="btn-ghost text-caption uppercase tracking-[0.2em] hover:text-future-blue transition-colors">Systems Design</button>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-22">
            {[
              ...
              >
                <span className="text-caption font-bold text-future-blue tracking-widest uppercase">{item.num}. Approach</span>
      ...
      <section className="py-220 px-4 md:px-12 bg-canvas border-y border-midnight-ink/5">
        <div className="max-w-[1440px] mx-auto flex justify-center text-center">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <span className="text-caption font-bold text-midnight-ink/30 uppercase tracking-[0.3em] mb-11 block">Engineering Philosophy</span>
            <h2 className="text-display font-w350 mb-11 leading-tight text-midnight-ink">Clarity and Precision.</h2>
      ...
      {/* Call to Action */}
      <section className="py-144 px-4 md:px-12 bg-midnight-ink text-ghost-white">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-center gap-11">
           <h2 className="text-display font-w350">Have a project in mind?</h2>
           <Link to="/contact" className="btn-pill bg-white text-midnight-ink hover:bg-future-blue hover:text-white flex items-center gap-6 group">
